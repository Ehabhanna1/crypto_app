...
class _SelectCoinState extends State<SelectCoin> {
        ...
        child: Column(
          children: [
           ...
           Expanded(child: Column(
             children: [
               Padding(
                 padding: EdgeInsets.symmetric(horizontal: myWidth*0.04,vertical: myHeight*0.02),
                 child: Row(
                   mainAxisAlignment: MainAxisAlignment.spaceBetween,
                   children: [
                     Column(
               ...
               Container(
                 height: myHeight*0.4,
                 width: myWidth,
                 child: isRefresh == true ? Center(child: CircularProgressIndicator(),):
                    itemChart == null
               ? Padding(
                     ...
                     itemBuilder: (context,index) {
                       return  Padding(
                         ...
                         child: GestureDetector(
                           ...
                           child: Container(
                             padding: EdgeInsets.symmetric(horizontal: myWidth*0.03,vertical: myHeight*0.005),
               ...
               Expanded(child: ListView(
                 children: [
                   Padding
                     ...
                     child: Text('News',style: TextStyle(fontSize: 25),),


                   ),
                   Padding(padding: EdgeInsets.symmetric(horizontal: myWidth*0.05,vertical: myHeight*0.01),
                     child: Row(
                       crossAxisAlignment: CrossAxisAlignment.start,
                       children: [
                  ...
                  Row(
                    children: [
                     ...
                     Expanded(
                       flex: 5,
                       child: Container(
                         padding: EdgeInsets.symmetric(vertical: myHeight*0.014),
                         decoration: BoxDecoration(
                         ...
                         child: Row(
                           ...
                           Icon(Icons.add,size: myHeight*0.025,color: Colors.white,),
                           Text('Add to portfolio',style: TextStyle(fontSize: 20,fontWeight: FontWeight.normal,color: Colors.white),),
                         ],),
                       ),
                      ...
                      Expanded(
                        flex: 2,
                          child: Container(
                            ...
                            child: Image.asset('assets/icons/3.1.png',height: myHeight*0.03,color: Colors.black87,),
                          ),),
                      SizedBox(width: myWidth*0.05,),
  ...
  List<bool> textBool = [false,false,false,false,false,false];
  int days = 30;
  setDays(String txt){
    if(txt == 'D'){
      setState(() {
  ...
  Future<void> getChart() async {
    String url = 'https://api.coingecko.com/api/v3/coins/' +
             widget.selectItem.id +'/ohlc?vs_currency=usd&days=' + days.toString();
